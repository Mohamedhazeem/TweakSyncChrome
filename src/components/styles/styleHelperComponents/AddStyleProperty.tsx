...
interface AddStylePropertyProps {
  ...
  // handleStyleChange: (selector: string, property: string, value: string) => void;
}
...
function AddStyleProperty({ selector, setStyles, addStyleProperty }: AddStylePropertyProps) {
  ...
  //   setValue(property);
  //   handleStyleChange(selector, property, "");
    ...
    setStyles((prevStyles) => {
      ...
      if (newStyleProperty) {
        ...
        if (selector === "inline") {
          ...
          updatedStyles.external.pseudoElementStyles[selector][newStyleProperty.name] = "";
        } else if (updatedStyles.external.pseudoClassStyles[selector]) {
          updatedStyles.external.pseudoClassStyles[selector][newStyleProperty.name] = "";
        } else if (updatedStyles.external.atRules[selector]) {
          for (const subSelector in updatedStyles.external.atRules[selector]) {
            updatedStyles.external.atRules[selector][subSelector][newStyleProperty.name] = "";
          }
        } else {
